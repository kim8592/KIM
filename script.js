...
const exportSMAS = async () => {
  ...
  try {
    ...
    alert("Đã lọc sạch dòng trống! Bạn dán thử vào Notepad sẽ thấy dữ liệu rất đẹp.");
  } catch (err) {
    alert("Lỗi copy!");
  }
};
...
>👥</button>
            ...
            <button onClick={exportSMAS} className="px-4 py-2 bg-green-600 text-white rounded-lg font-bold text-[11px] uppercase shadow-md">
              🚀 TẢI LÊN SMAS
            </button>
          </div>
        </div>
